...
public class QuadraticProbingHashTable<AnyType> {
    ...
    public void insert(AnyType x){
        ...
        if(++currentPos > array.length/2) rehash();
    }
    ...
    private int findPos(AnyType x){
        ...
        return currentPos;}
    private void rehash(){}
    private int myhash(AnyType x){return 0;}
    private static int nextPrime(int n){return n;}
    private static boolean isPrime(){return false;}
}
