...
public class UserServiceClient {
    public static final String SERVER_URL = "http://localhost:8081/router";
    ...
    public void createSession(){
        ...
        CompositeResponse response = ropClient.buildClientRequest().post(ropRequest,LogonResponse.class,"user.getSession","1.0");
